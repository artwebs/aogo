...
func (this *Driver) Insert(values map[string]interface{}) (int64,error) {
	this.Conn()
	defer this.Close()
	var fm ,vm string
	val := []interface{}{}
...
func (this *Driver) Update(values map[string]interface{})(int64,error) {
	this.Conn()
	defer this.Close()
	u := ""
	val :=[]interface{}{}
...
func (this *Driver) Delete()(int64,error) {
	this.Conn()
	defer this.Close()
	val :=[]interface{}{}
...
func (this *Driver) Find()(map[string]string,error) {
	this.Conn()
	defer this.Close()
	var args []interface{}
	sql := this.initSelect()
...
func (this *Driver) Total() (int,error) {
	this.Conn()
	defer this.Close()
	var args []interface{}
...
func (this *Driver) Select()([]map[string]string,error) {
	this.Conn()
	defer this.Close()
	var args []interface{}
	sql := this.initSelect()
...
func (this *Driver) Where(w string,args ...interface{}) *Driver {
	this.where = w
	this.whereArgs = args
	return this
}

func (this *Driver) Order(o string) *Driver {
	this.order = o
	return this
}

func (this *Driver) Limit(l string) *Driver {
	this.limit = l
	return this
}

func (this *Driver) Group(g string) *Driver {
	this.group = g
	return this
}

func (this *Driver) Having(h string) *Driver {
	this.having = h
	return this
}

func (this *Driver) Field(fields ...string) *Driver {
	this.fields = fields
	return this
}
